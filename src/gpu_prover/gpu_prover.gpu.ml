...
module Mnt4753_backend :
  Groth16_gpu_prover.Prover_intf with module Backend := Snarky_libsnark_bindings.Libsnark.Mnt4753 =
struct
  include Groth16_gpu_prover.Mnt4753 (Snarky_libsnark_bindings.Libsnark.Mnt4753)
end

module Mnt6753_backend :
  Groth16_gpu_prover.Prover_intf with module Backend := Snarky_libsnark_bindings.Libsnark.Mnt6753 =
struct
  include Groth16_gpu_prover.Mnt6753 (Snarky_libsnark_bindings.Libsnark.Mnt6753)
end

module Base_proof_system
    (Backend : Groth16_gpu_prover.Prover_intf)
    (Basic : Snarky.Snark_intf.Basic
...
struct
  module Preprocessed_proving_key = struct
    (* Representation of the preprocessed proving key. These values can be
       manipulated by the Snarky_libsnark_bindings.libsnark bindings (e.g. to store/load from a file),
...
module Make_Mnt4753_Basic = Make_basic (struct
  module Backend = Snarky_libsnark_bindings.Libsnark.Mnt4753
...
module Make_Mnt6753_Basic = Make_basic (struct
  module Backend = Snarky_libsnark_bindings.Libsnark.Mnt6753
...
let%test_module "gpu-test" =
  ( module struct
    module M4753 = Make_Mnt4753 (Snarky.Snark0.Make (Snarky_libsnark_bindings.Libsnark.Mnt4753.Default))
    module M6753 = Make_Mnt6753 (Snarky.Snark0.Make (Snarky_libsnark_bindings.Libsnark.Mnt6753.Default))
  end )
